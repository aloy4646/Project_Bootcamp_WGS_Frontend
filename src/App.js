        ...
        <Box sx={{ display: 'flex', mt: 8 }}>
          ...
          >
            <Routes>
              ...
              <Route path="/karyawan/update/form/data/:id" element={user && user.role !== "SUPER ADMIN" ? <FormUserData /> : <Navigate to="/" />} />
              ...
              <Route path="/karyawan/update/password/:id" element={user && user.role !== "SUPER ADMIN" ? <UpdatePassword /> : <Navigate to="/" />} />
